...
public class ChatTranscriptJsonConverter {
    ...
    private GregorianCalendar chatStartedAt = new GregorianCalendar();
     ...
     */
    public ChatItem prepareChatItemForConversion(ChatTranscriptItem item, Calendar fromDateCal) {
        if (
            fromDateCal != null &&
    ...
    class NickTypePair {
        ...
        public String toString() {
            return "NickTypePair [userNick=" + userNick + ", userType="
                + userType + "]";
        }
    }
